...
//   description: 'Subcription more discription',
// }
    ...
    <div>
      <div className="flex justify-start sm:items-center max-[630px]:items-start px-[20px] pt-4 pb-1 ">
        ...
        <div>
          ...
          <button className="bg-gray-100 text-[14px] font-[500] rounded-[18px] leading-[36px] px-4 me-2">Customise channel</button>
            <button className="bg-gray-100 text-[14px] font-[500] rounded-[18px] leading-[36px] px-4 ">Manage videos</button>
          </div>
        </div>
      </div>
      <div className="border-b-[1px] border-gray-200">
      <div className="flex items-center ml-[20px]">
        <button className={`text-[16px] font-[500] mr-6 leading-[48px] tab_btn ${getActiveClass(1, "active-tabs")}`} onClick={()=> ToggleTab(1)}> Home</button>
        <button className={`text-[16px] font-[500] mr-6 leading-[48px] tab_btn ${getActiveClass(2,  "active-tabs")}`} onClick={()=> ToggleTab(2)}> Short</button>
        <button className={`text-[16px] font-[500] mr-6 leading-[48px] tab_btn ${getActiveClass(3, "active-tabs")}`} onClick={()=> ToggleTab(3)}> Playlist</button>
<button className='text-[16px] font-[500] mr-6 leading-[48px] tab_btn'> 
    ...
    <svg xmlns="http://www.w3.org/2000/svg" style={{width: '20px', height: '20px'}} viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M10.25 2a8.25 8.25 0 0 1 6.34 13.53l5.69 5.69a.749.749 0 0 1-.326 1.275a.749.749 0 0 1-.734-.215l-5.69-5.69A8.25 8.25 0 1 1 10.25 2M3.5 10.25a6.75 6.75 0 1 0 13.5 0a6.75 6.75 0 0 0-13.5 0" style={{width: '20px', height: '20px'}}></path></svg>
      ...
      <div className={`content lg:pl-4 sm:pl-3 max-[630px]:ml-3 lg:mt-6 sm:mt-3 max-[630px]:mt-3 ${getActiveClass(1, "active-content")}`}>
      <div className="flex w-[24px] ml-8 lg:mb-6 sm:mb-3 max-[630px]:mb-3  justify-center items-center ">
<div className="w-9 ">
<svg xmlns="http://www.w3.org/2000/svg" style={{width: '24px', height: '24px'}} viewBox="0 0 24 24" {...props}><path fill="red" d="m18.931 9.99l-1.441-.601l1.717-.913a4.48 4.48 0 0 0 1.874-6.078a4.506 4.506 0 0 0-6.09-1.874L4.792 5.929a4.504 4.504 0 0 0-2.402 4.193a4.521 4.521 0 0 0 2.666 3.904c.036.012 1.442.6 1.442.6l-1.706.901a4.51 4.51 0 0 0-2.369 3.967A4.528 4.528 0 0 0 6.93 24c.725 0 1.437-.174 2.08-.508l10.21-5.406a4.494 4.494 0 0 0 2.39-4.192a4.525 4.525 0 0 0-2.678-3.904Zm-9.334 5.2V8.824l6.007 3.184z"></path></svg>

</div>
<p className="lg:text-[20px] sm:text-[18px] max-[630px]:text-[18px] font-bold"> Shorts </p>
</div>
<div className="lg:w-[210px] sm:w-[148px] lg:h-[351px] sm:h-[248px] max-[630px]:h-[248px] max-[630px]:w-[148px]">
<Video4 image4='https://img.freepik.com/free-photo/portrait-handsome-attractive-singer_1150-16926.jpg?size=626&ext=jpg&ga=GA1.1.1351396951.1702663879&semt=ais' className='' head1='February 4, 2023' head2='1 Views'/>
</div> </div>

<div  className={`content lg:pl-4 sm:pl-3 max-[630px]:ml-3 lg:mt-6 sm:mt-3 max-[630px]:mt-3 ${getActiveClass(2, "active-content")}`}>
<div className="w-[210px] !h-[351px] max-[630px]:h-[248px] max-[630px]:w-[148px]">
<Video4 image4='https://img.freepik.com/free-photo/medium-shot-man-recording-himself_23-2150336096.jpg?size=626&ext=jpg&ga=GA1.1.1351396951.1702663879&semt=ais' head1='February 4, 2023' head2='1 Views'/>
</div> </div>
<div className={`content lg:pb-16 sm:pb-[84px] max-[630px]:pb-[125px]  ${getActiveClass(3, "active-content")}`}>
  <div className="flex justify-between h-[56px] mx-4 my-2 items-center">
    <div><p className="text-[16px] font-[500]">Created playlists</p></div>
    <div className="flex">
 ...
 <p className="text-[16px] font-[500]">Sort by</p></div>
  </div>
<div className="w-[210px] !h-[118px] relative group/item" style={{marginLeft: '16px'}}>
...
<div className="text-[16px] lg:text-[rgb(96,96,96)] sm:text-[#000] max-[640px]:text-[#000] font-normal">Sub</div>
<div className="flex">
  <div className="bg-gray-100 py-[3px]">
            <svg xmlns="http://www.w3.org/2000/svg"  className="min-w-4 min-h-4"
                  style={{ width: "16px", height: "16px" }} viewBox="0 0 24 24" {...props}><path fill="#606060" d="M6 22q-.825 0-1.412-.587T4 20V10q0-.825.588-1.412T6 8h1V6q0-2.075 1.463-3.537T12 1q2.075 0 3.538 1.463T17 6v2h1q.825 0 1.413.588T20 10v10q0 .825-.587 1.413T18 22zm0-2h12V10H6zm6-3q.825 0 1.413-.587T14 15q0-.825-.587-1.412T12 13q-.825 0-1.412.588T10 15q0 .825.588 1.413T12 17M9 8h6V6q0-1.25-.875-2.125T12 3q-1.25 0-2.125.875T9 6zM6 20V10z"></path></svg>
</div><p className="text-sm font-[500] bg-gray-100 text-[#606060] py-[3px] pr-1">          
       Private
            </p>
 </div>
