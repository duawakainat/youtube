  ...
  return (
    <div>
      ...
      <div className="lg:flex sm:hidden max-[630px]:hidden justify-between items-center mt-6 px-4">
        ...
        <div className="">
          <p className="text-sm text-[#065fd4] px-4 font-[500]">
            Download settings
          </p>
        </div>
      </div>
      <div
        className="w-[210px] !h-[118px] relative group/item mt-6"
        style={{ marginLeft: "16px" }}
      >
        <Video4
          image4="https://img.freepik.com/premium-photo/3d-stylized-illustration-3d-render-high-resolution_617193-372.jpg?size=626&ext=jpg&ga=GA1.1.1351396951.1702663879"
          head1="Watch Later"
        />
        ...
        <div className="text-[12px] lg:text-[rgb(96,96,96)] mt-1 sm:text-[#000] max-[640px]:text-[#000] font-normal">
          kainat hafeez
        </div>
        <div className="flex">
          <p className="text-xs px-1 py-[3px] mt-1 text-[#606060] bg-gray-200">
            Downloaded
          </p>
        </div>
