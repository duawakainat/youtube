              ...
              <div className=" lg:p-6 lg:pb-0 lg:w-[100%] sm:max-w-[720px] sm:pb-4 grid lg:grid-cols-1 sm:grid-cols-2 max-[630px]:grid-cols-1 max-[450px]:grid-cols-1 max-[450px]:mx-0 sm:min-w-720 mx-auto">
                ...
                <div className="lg:pl-0 lg:pb-0 sm:pl-6 sm:pb-4 max-[630px]:pb-4 max-[630px]:px-4 max-[450px]:pb-3">
                  <div className="flex justify-between items-center">
                    {" "}
                    <h2 className="text-[28px] font-[700] text-white">Sub</h2>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="w-6 h-6"
                      viewBox="0 0 24 24"
                  ...
                  <div className="mt-4 text-white">
                    ...
                    <div className="flex items-center py-2">
                      {" "}
                      <p className="mb-1 text-sm font-[500]">Private</p>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="w-6 h-6"
                        viewBox="0 0 24 24"
                    ...
                    <p className="mb-3 text-xs font-[400] line-clamp-1 ">
                      {" "}
                      3 video<span className="mr-1"> 3 video</span>{" "}
                      <span className="mr-1">Update today</span>{" "}
                    </p>
                  </div>
                  <div className="flex">
                  ...
                  <div className="flex justify-between items-center text-white">
                    {" "}
                    <p className="mb-1 text-sm font-[500]">No Discription</p>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="w-6 h-6"
                      viewBox="0 0 24 24"
