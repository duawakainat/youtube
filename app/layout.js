            ...
            <div className="flex items-center justify-start rtl:justify-end sm:col-span-1 max-[630px]:col-span-2">
              <div className="flex justify-between items-center relative">
                <div className="flex items-center">
                  ...
                  >
                    <Image
                      src="/YouTube_Logo_2017.svg.png" alt="image" className="max-h-5 max-w-[90px] max-[630px]:w-20 max-[630px]:h-5" width={90} height={20}/>
                  </div>
                </div>
              </div>
            </div>
            <form className="lg:col-span-4 md:col-span-5 sm:col-span-5 max-[630px]:col-span-4">
              <div className="lg:flex justify-center items-center h-14 md:block row">
                ...
                <div className=" icon ms-3">
                  <button
                    type="submit"
                    className="flex justify-center items-center w-10 h-10 min-[600px]:h-5 min-[300px]:h-5 lg:h-10 md:h-10  bg-gray-100  border-indigo-500 rounded-full end-0 text-sm font-medium text-[#ccc] lg:flex md:hidden sm:hidden max-[630px]:hidden"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
