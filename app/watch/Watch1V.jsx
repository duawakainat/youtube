        ...
        <div className="lg:col-span-4 lg:pr-6 pt-6 lg:pb-16 sm:pb-[115px] max-[630px]:pb-[115px]">
          ...
          {video.map((menu, index) => {
            return (
              <div
                key={index}
                className="mt-3 lg:ms-0 sm:ms-3 max-[630px]:ms-0"
              >
                ...
                ></iframe> */}
                  <video
                    className="!max-h-[90px] !min-w-[160px] max-[630px]:min-w-[160px] max-[630px]:max-h-[90px] mr-4 rounded-lg max-[600px]:rounded-[12px] object-cover"
                    poster={menu.imageV}
                  >
                    <source
                      src="https://www.youtube.com/watch?v=geDJIcOU7dg"
                  ...
                  <div className="group/item">
                    <div className="flex justify-around lg:items-center">
                      <div>
                      ...
                      <div className="flex">
                        ...
                        <div className="w-6 h-6 lg:invisible group-hover/item:visible max-[630px]:visible">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="w-6 h-6"
                            viewBox="0 0 24 24"
