...
<video className="object-cover lg:rounded-md sm:rounded-md VideoL"  poster={props.image4}>
  ...
  <div className="lg:relative md:absolute sm:absolute max-[640px]:absolute lg:bottom-0 sm:bottom-2 max-[640px]:bottom-2 max-[640px]:left-2 sm:left-2 sm:right-1 max-[640px]:right-1">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" className='group-hover/edit:translate-x-0.5 group-hover/edit:text-slate-500' style={{width: '24px', height: '24px'}} viewBox="0 0 24 24" {...props}><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 12a1 1 0 1 0 2 0a1 1 0 1 0-2 0m0 7a1 1 0 1 0 2 0a1 1 0 1 0-2 0m0-14a1 1 0 1 0 2 0a1 1 0 1 0-2 0" style={{width: '24px', height: '24px'}}></path></svg>
 
    </div></div>
                <div className="text-xs lg:text-[rgb(96,96,96)] sm:text-[#ffffff] max-[640px]:text-[#ffffff] font-normal">{props.head2}</div>
            </div>
        </div> 
    </div>
    )}
