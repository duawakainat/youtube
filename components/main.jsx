...
<path stroke="#0f0f0f" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 13 5.7-5.326a.909.909 0 0 0 0-1.348L1 1"/>
 ...
 <nav className="top-0 z-50 w-full lg:shadow-none sm:shadow-md max-[640px]:shadow-md dark:bg-gray-800 dark:border-gray-700 h-14 ">
  <div className="px-3">
...
<div className="grid grid-cols-3 lg:grid-cols-3 md:grid-cols-3 min-[864px]:grid-cols-3 max-[864px]:grid-cols-2 min-[578px]:grid-cols-2 max-[578px]:grid-cols-1 mx-4 my-6 gap-4 mb-4">
       ...
       <div className='w-100'>  <div className="items-center w-100 justify-center rounded dark:bg-gray-800">
         <Video/>
         </div>
         </div>
         <div className='w-100'>
         <div className="items-center justify-center rounded dark:bg-gray-800">
         <Video/>         
         </div></div>
         <div className='w-100'>
         <div className="items-center justify-center rounded dark:bg-gray-800"><Video/>
         </div></div>
      {/* </div>
...
<Video/>
         ...
         <div className="items-center justify-center rounded bg-gray-50 dark:bg-gray-800"><Video/>
