...
export default function Video(props) {
  ...
  return (
    <div className="App sticky right-0 left-0 bg-white top-0 z-[999]">
      ...
      {scrollX !== 0 && (
        ...
        >
          ...
          >
            <path
              fill="currentColor"
              d="M10 21.308L.692 12L10 2.692l1.063 1.064L2.82 12l8.244 8.244L10 21.308Z"
            ></path>
          </svg>
        </button>
      )}
      ...
      {!scrolEnd !== 0 && (
        <button className="prev pr-4" onClick={() => slide(+50)}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="1em"
            height="1em"
