...
export default function Video(props) {
  return (
    <div className='lg:h-[333px]  sm:h-[288px] max-[630px]:h-[211px] block items-start'>
...
<video className="VideoS lg:h-48 md:h-40 sm:h-48 rounded-2xl" poster={props.imageV}>
  ...
  <div className="flex flex-row">
            <Image className="rounded-[50%] lg:min-w-[36px] lg:!min-h-[36px] mt-3 mr-3 md:w-10 sm:w-10 h-10" width={36} height={36} src="/sreejith-kalesh-qTmrnmiEwLQ-unsplash.jpg" alt="profile picture"/>
