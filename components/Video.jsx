...
<video className="VideoS lg:h-48 md:h-40 sm:h-48 rounded-2xl" poster={props.imageV} autoPlay muted controls>
  ...
  <div className="flex flex-row">
            ...
            <div className="space-y-0.5  dark:text-white text-left rtl:text-right mr-6">
                <h3 className='leading-4 md:leading-[18px]  lg:text-lg md:text-sm sm:text-sm max-[640px]:text-sm mt-3 text-[#0f0f0f] font-medium'>Mix Rahiya Sohniya Madinay Wal Ja Ke | Sahir Ali Bagga | Naat</h3>
