...
const HistoryC1 = (props) => {
  const [video, setVideo] = useState ([
    ...
    imageV:'https://img.freepik.com/free-psd/club-dj-party-flyer-social-media-post_505751-3058.jpg?size=626&ext=jpg&ga=GA1.1.1351396951.1702663879&semt=ais',
      image:
        "https://img.freepik.com/free-vector/happy-new-year-background_23-2148022232.jpg?size=626&ext=jpg&ga=GA1.1.1351396951.1702663879&semt=ais", title:"LIVE | Level Playing Field to PTI | Latif Khosa Emergency Media Talk Outside Supreme Court", TV: 'Capital TV', Kilo: '19k views', icon: Tick, short: "#latifkhosa #aitzazahsan #shoaibshaheen #ptichairmanimrankhan #ciphercase #adialajail #batsymbol #naeemhaiderpanjutha..."
    },
    { index: "2",
    imageV:'https://img.freepik.com/premium-psd/psd-music-festival-event-flyer-template-social-media-post-with-red-color-wood-background_507402-603.jpg?size=626&ext=jpg&ga=GA1.1.1351396951.1702663879&semt=ais',
      image:
        "https://img.freepik.com/free-vector/happy-new-year-background_23-2148022232.jpg?size=626&ext=jpg&ga=GA1.1.1351396951.1702663879&semt=ais", title:"LIVE | Level Playing Field to PTI | Latif Khosa Emergency Media Talk Outside Supreme Court", TV: 'Capital TV', Kilo: '19k views', icon: Tick, short: "#latifkhosa #aitzazahsan #shoaibshaheen #ptichairmanimrankhan #ciphercase #adialajail #batsymbol #naeemhaiderpanjutha..."
    },
    { index: "3",
    ...
    { index: "6",
    imageV:'https://img.freepik.com/premium-psd/bus-stop-billboard-mockup_23-2147912068.jpg?size=626&ext=jpg',
      image:
        "https://img.freepik.com/free-vector/happy-new-year-background_23-2148022232.jpg?size=626&ext=jpg&ga=GA1.1.1351396951.1702663879&semt=ais", title:"LIVE | Level Playing Field to PTI | Latif Khosa Emergency Media Talk Outside Supreme Court", TV: 'Capital TV', Kilo: '19k views', Icon: Tick
    },
  ])
  ...
  return (
    <div className="">
      .<h1 className="text-[36px] lg:px-6 sm:px-3 max-[630px]:px-3 pt-6 pb-1 font-bold">Watch History</h1>
      ...
      <p className="text-[20px] font-[700] lg:px-6 pt-6 pb-2">Today</p>
          {video.map((menu, index) => {
            return <div key={index} className="mt-3">
                ...
                <video className="lg:max-h-[128px] sm:max-h-[90px] sm:min-w-[160px] object-cover max-[600px]:min-w-[160px] max-[630px]:max-h-[90px] mr-4 rounded-lg" poster={menu.imageV}>
        <source src="https://www.youtube.com/watch?v=geDJIcOU7dg" className='w-100' type="video/mp4"/>
          ...
          <div className="w-10 h-10" onClick={()=>removeElement(menu.index)}>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" viewBox="0 0 24 24" {...props}><g fill="none"><path fillRule="evenodd" clipRule="evenodd" d="M10 5a2 2 0 1 0 4 0a2 2 0 0 0-4 0zm0 7a2 2 0 1 0 4 0a2 2 0 0 0-4 0zm0 7a2 2 0 1 0 4 0a2 2 0 0 0-4 0z" fill="currentColor"></path></g></svg>
                ...
                <div className="flex justify-start items-center">
                    ...
                    {/* <menu.Icon /> */}<div  className='w-[3px] h-[3px] bg-[#606060] rounded-full mx-1'> .</div>
...
<input className=" border-b-[1px] col-span-2 border-[#606060] outline-0 text-[14px] flex items-center h-10 ps-8" placeholder="Search Watch Later"/>
<div className="absolute left-0 bottom-[-0.1rem] flex items-center h-10">    
    
    <svg xmlns="http://www.w3.org/2000/svg" className='w-6 h-6' viewBox="0 0 24 24" {...props}><path fill="currentColor" d="m19.485 20.154l-6.262-6.262q-.75.639-1.725.989q-.975.35-1.96.35q-2.402 0-4.066-1.663q-1.664-1.664-1.664-4.065T5.47 5.436q1.663-1.667 4.064-1.667q2.402 0 4.068 1.664q1.666 1.664 1.666 4.067q0 1.042-.369 2.017q-.37.975-.97 1.668l6.262 6.261zM9.538 14.23q1.99 0 3.361-1.37q1.37-1.37 1.37-3.361q0-1.99-1.37-3.36q-1.37-1.37-3.36-1.37q-1.99 0-3.361 1.37q-1.37 1.37-1.37 3.36q0 1.99 1.37 3.36q1.37 1.37 3.36 1.37" className='w-8 h-7'></path></svg>
 </div></div>
        </div>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mr-1.5 ml-[-6px]" viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M7.615 20q-.67 0-1.143-.472Q6 19.056 6 18.385V6H5V5h4v-.77h6V5h4v1h-1v12.385q0 .69-.462 1.152q-.463.463-1.153.463zM17 6H7v12.385q0 .269.173.442t.442.173h8.77q.23 0 .423-.192q.192-.193.192-.423zM9.808 17h1V8h-1zm3.384 0h1V8h-1zM7 6v13z"></path></svg>
 ...
 Clear all watch history
    ...
    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mr-1.5 ml-[-6px]" viewBox="0 0 24 24" {...props}><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"><path d="M13 15L8 18L8 6L13 9L13 9"><animate fill="freeze" attributeName="d" dur="0.6s" keyTimes="0;0.33;1" values="M13 15L8 18L8 6L13 9L13 9;M13 15L8 18L8 6L13 9L13 15;M9 18L7 18L7 6L9 6L9 18"></animate></path><path d="M13 9L18 12L18 12L13 15L13 15"><animate fill="freeze" attributeName="d" dur="0.6s" keyTimes="0;0.33;1" values="M13 9L18 12L18 12L13 15L13 15;M13 9L18 12L18 12L13 15L13 9;M15 6L17 6L17 18L15 18L15 6"></animate></path></g></svg>
  <p className=" text-[14px] font-[500]">
Pause watch history
</p></div>
        </div>
