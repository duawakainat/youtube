...
const video = [
  {
    video1I: "https://www.youtube.com/embed/2fKRFjtMvqU?autoplay=1&si=7Kc2iVC27NhuSnOB",
    disccription:
...
const ShortP = (props) => {
  ...
  return (
    ...
    <div className="h-screen relative">
      <div className="flex justify-center relative items-end lg:bg-white sm:bg-black max-[635px]:bg-black "  style={{width: "100%"}}>
        <div className="relative lg:h-[580px] lg:w-[320px] sm:w-[100%] max-[635px]:w-[100%] lg:pb-[116px] sm:pb-[115px] max-[630px]:pb-[115px]">
          <div className="flex justify-center">
            <iframe
              width=""
              height=""
              className="lg:!w-[320px] md:!w-[520px] sm:!w-[420px] sm:!w-100 lg:h-[570px] sm:!min-h-[100vh] max-[630px]:!min-h-[100vh] max-[630px]:!w-[100%]"
        ...
        <div className="flex flex-col lg:relative sm:absolute md:right-0 sm:right-0 max-[630px]:absolute max-[630px]:right-0  items-end px-3">
          <div className="pt-4">
            <div className="!min-w-[48px] !min-h-[48px] flex items-center justify-center rounded-full bg-gray-100 ">
              <svg
          ...
          <div className="pt-4">
            <div className="!min-w-[48px] !min-h-[48px] flex items-center justify-center rounded-full bg-gray-100 ">
            <svg xmlns="http://www.w3.org/2000/svg" className="min-w-6 min-h-6"
                style={{ width: "24px", height: "24px" }} viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M3 13.5C3 9.36 6.36 6 10.5 6H13V2l7 6l-7 6v-4h-2.5C8.57 10 7 11.57 7 13.5V21H3z" className="min-w-6 min-h-6"
                style={{ width: "24px", height: "24px" }}></path></svg>
          ...
          <div className="pt-4">
            <div className="!min-w-[48px] !min-h-[48px] flex items-center justify-center rounded-full bg-gray-100 ">
            <svg xmlns="http://www.w3.org/2000/svg" className="min-w-6 min-h-6"
                style={{ width: "24px", height: "24px" }} viewBox="0 0 256 256" {...props}><path fill="currentColor" d="M144 128a16 16 0 1 1-16-16a16 16 0 0 1 16 16m-84-16a16 16 0 1 0 16 16a16 16 0 0 0-16-16m136 0a16 16 0 1 0 16 16a16 16 0 0 0-16-16" className="min-w-6 min-h-6"
                style={{ width: "24px", height: "24px" }}></path></svg>
            </div>
         </div>
         <div className="pt-4">
            <div className="w-[40px] h-[40px] rounded-md bg-gray-100 ">
            <Image src={video[AvtiveImage].image} className="w-[40px] h-[40px] rounded-md"/>
            </div>
         </div>
        </div>
      </div>
      ...
      <div className="px-4 py-2" onClick={Pre}>
            <div className="w-[56px] h-[56px] flex items-center justify-center rounded-full bg-gray-100 ">
    <svg xmlns="http://www.w3.org/2000/svg" className="min-w-6 min-h-6"
                style={{ width: "24px", height: "24px" }} viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M11.5 19V6.921l-5.792 5.792L5 12l7-7l7 7l-.708.713L12.5 6.921V19z" className="min-w-6 min-h-6"
                style={{ width: "24px", height: "24px" }}></path></svg>
    </div></div>
      </button></div>
      ...
      <div className="px-4 py-2">
            <div className="w-[56px] h-[56px] flex items-center justify-center rounded-full bg-gray-100 ">   
    <svg xmlns="http://www.w3.org/2000/svg" className="min-w-6 min-h-6"
                style={{ width: "24px", height: "24px" }} viewBox="0 0 24 24" {...props}><path fill="currentColor" d="M11.5 5v12.079l-5.792-5.792L5 12l7 7l7-7l-.708-.713l-5.792 5.792V5z" className="min-w-6 min-h-6"
                style={{ width: "24px", height: "24px" }}></path></svg>
    </div></div>
      </button></div>
    </div></div>
