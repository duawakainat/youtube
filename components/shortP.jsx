  ...
  return (
    ...
    <svg xmlns="http://www.w3.org/2000/svg" className='w-6 h-6' viewBox="0 0 24 24" {...props}><path fill="#fff" fillRule="evenodd" d="M10.53 5.47a.75.75 0 0 1 0 1.06l-4.72 4.72H20a.75.75 0 0 1 0 1.5H5.81l4.72 4.72a.75.75 0 1 1-1.06 1.06l-6-6a.75.75 0 0 1 0-1.06l6-6a.75.75 0 0 1 1.06 0" clipRule="evenodd"></path></svg>
          ...
          <div className="flex flex-col lg:relative sm:absolute md:right-0 sm:right-0 max-[630px]:absolute max-[630px]:right-0  items-end px-3">
            ...
            <div className="lg:pt-4">
              <div
                className="!min-w-[48px] !min-h-[48px] flex items-center justify-center rounded-full lg:bg-gray-100 sm:bg-[rgba(255,255,255,0.1)] max-[630px]:bg-[rgba(255,255,255,0.1)]"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="min-w-6 min-h-6 lg:text-black text-white"
