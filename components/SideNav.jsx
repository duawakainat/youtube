...
const menuItem = [
  ...
  { id: 3, Label: "Subcription", icon: Subcription, link: "/Subcription" },
];
const menuItem7 = [
  { id: 1, Label: "Home", icon: Home, link: "/" },
  { id: 2, Label: "Short", icon: Short, link: "/short" },
  { id: 3, Label: "Subcription", icon: Subcrip2, link: "/Subcription" },
];
const menuItem2 = [
  { id: 1, Label: "Your Channel", icon: Channel, link: "/YourChannel" },
...
const SideNav = () => {
  ...
  const wrapperClesses = classNames(
    ...
    {
      ["w-60 flex px-4 overflow-y-hidden hover:overflow-y-scroll"]: !toogleCallapse,
      ["w-20 flex flex-col justify-center px-0"]: toogleCallapse,
    }
  );
      ...
      >
        ...
        <div className="flex flex-col items-start justify-center">
          {menuItem7.map(({ icon: Icon, ...menu }) => {
            ...
            return (
              <div
                key={menu.id}
                className="flex justify-center items-center cursor-pointer hover:bg-gray-100 rounded-md w-full whitespace-nowrap"
              >
                <Link href={menu.link}>
                  <div className="flex items-center justify-center w-full">
                    {toogleCallapse && (
                      ...
                      >
                        ...
                        >
                          <Icon
                            className="flex justify-center text-center mb-1.5"
                            style={{ width: "1.5rem", height: "1.5rem" }}
                          ></Icon>
                          <span
                            className={classNames(
                              "text-[10px] font-medium text-text-light"
                            )}
                          >
                            {menu.Label}
                          </span>
        ...
        <div className="flex flex-col items-start">
          {menuItem2.map(({ icon: Icon, ...menu }) => {
            const classes = getNavItemClasess(menu);
            return (
              <div key={menu.id} className={classes} style={{ height: "40px" }}>
                <Link href={menu.link}>
        ...
        <div className="flex items-center cursor-pointer hover:bg-gray-100 rounded-md w-full whitespace-nowrap">
          ...
          >
            <div className="flex items-center px-3 w-full h-full">
              ...
              {!toogleCallapse && (
                <span
                  className={classNames("text-sm font-medium text-text-light")}
                >
                  Show More
                </span>
              )}
        ...
        {!toogleCallapse && (
          <ul>
            ...
            <li>
              ...
              >
                <span className="flex me-3 font-medium whitespace-nowrap">
                  Subscription
                </span>
              </a>
            </li>
